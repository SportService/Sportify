...
public class ServiceClassementUser implements IService<ClassementUser> {

    private Connection con ;

    public ServiceClassementUser() {
    ...
    public List<ClassementUser> afficher() throws SQLException {
        ...
        String req = "SELECT c.*, u.* " +
                ...
                "LEFT JOIN Utilisateur u ON c.user_id = u.ID_User ORDER BY c.rank ASC";
        ...
        try (PreparedStatement pre = con.prepareStatement(req);
            ...
            while (res.next()) {
                ...
                if (res.getObject("user_id") != null) {
                    ...
                    user.setId(res.getInt("u.ID_User"));
