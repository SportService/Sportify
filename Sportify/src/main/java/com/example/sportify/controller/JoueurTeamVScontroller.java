...
public class JoueurTeamVScontroller implements Initializable {
    ...
    private Utilisateurss loggedUser;
    ...
    public void initData(Utilisateurss User) {
    ...
    public void setMatchDetails(int matchId) throws SQLException {
        ...
        if (compet != null) {
            ...
            if ((compet.getEquipe1() != null) || (compet.getEquipe2() != null)) {
                ...
                List<Utilisateurss> membresEquipe1 = equipeservice.getEquipeMembres(compet.getEquipe1());
                for (Utilisateurss membre : membresEquipe1) {
                ...
                List<Utilisateurss> membresEquipe2 = equipeservice.getEquipeMembres(compet.getEquipe2());
                for (Utilisateurss membre : membresEquipe2) {
