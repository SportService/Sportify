   ...
   /* private void updateClassement(Equipe winner, Equipe loser, boolean isDraw) {
    ...
    private void updateClassementUser(Equipe winner, Equipe loser, boolean isDraw) {
        try {
            ...
            List<Utilisateurss> playersWinner = EquipeMembreService.getEquipeMembres(winner);
            List<Utilisateurss> playersLoser = EquipeMembreService.getEquipeMembres(loser);

            // For solo matches, handle each player individually
                for (Utilisateurss playerW : playersWinner) {
                ...
                for (Utilisateurss playerL : playersLoser) {
            ...
            for (ClassementUser classementUser : classementUserList) {
                for (Utilisateurss player : playersWinner) {
                ...
                for (Utilisateurss player : playersLoser) {
                    if (classementUser.getUser().getId() == player.getId()) {
