...
public class Utilisateur {
    ...
    public Utilisateur(int id, String nom, String prenom, String mot_de_passe, String image, String email, String adresse, String niveau_competence, String role, String date_de_naissance) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
